...
parser.add_argument('--input_dir', default='D:/machao/python/Training_Images/Training_data/', type=str, help='Input images')
...
parser.add_argument('--weights',
                    default='D:/machao/python/SUNet/checkpoints/Denoising/models/model_latest.pth', type=str,
...
for file_ in files:
    ...
    input_ = TF.to_tensor(img).unsqueeze(0).cuda(device=1)
    with torch.no_grad():
    ...
    restored = img_as_ubyte(restored[0])  # 像素值灰度转到0-255
